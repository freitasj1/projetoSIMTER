...
String CHARACTERISTIC_UUID1 = "ceb5483e-46e1-4688-b7f5-ea07361b26a8";
String CHARACTERISTIC_UUID2 = "ceb5483e-46e1-4688-b7f5-ea07361b26a9";
...
void loop() {
  ...
  if (myDevice) {
    ...
    if (pClient->isConnected()) {
      ...
      delay(200);
      //for (int i = 0; i < L; i++){
      BLERemoteCharacteristic* pRemoteCharacteristic1 = pRemoteService->getCharacteristic(BLEUUID(CHARACTERISTIC_UUID1));
      Serial.println("leu!!!!");
      BLERemoteCharacteristic* pRemoteCharacteristic2 = pRemoteService->getCharacteristic(BLEUUID(CHARACTERISTIC_UUID2));
      Serial.println("leu!!!");
      // Lê o valor da característica
      String value = pRemoteCharacteristic1->readValue();
      Serial.println("leu1!");

      //String valor = pRemoteCharacteristic2->readValue();
      //Serial.println("leu2!"); 
